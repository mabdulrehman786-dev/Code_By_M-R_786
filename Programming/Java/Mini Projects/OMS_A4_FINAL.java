...
class OfficeManagementSystemGUI extends JFrame {
    ...
    private void createComponents() {
        // Panel for employee type selection
        JPanel typePanel = new JPanel();
        typePanel.setLayout(new FlowLayout());
        typePanel.add(new JLabel("Select Employee Type: "));
        
        JButton managerBtn = new JButton("Manager");
        JButton staffBtn = new JButton("Staff");
        typePanel.add(managerBtn);
        typePanel.add(staffBtn);
        ...
        empAgeField = new JTextField(10);
        inputPanel.add(empAgeField);
        
        inputPanel.add(new JLabel("Salary:"));
        empSalaryField = new JTextField(10);
        inputPanel.add(empSalaryField);
        
        inputPanel.add(new JLabel("Bonus (Manager):"));
        ...
        JButton saveBtn = new JButton("Save Employee"); // New Save button
